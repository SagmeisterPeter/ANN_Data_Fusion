...
conv1_NMR = Conv1D(filters=16, kernel_size=9, strides=9, activation ='relu')(visible_NMR)
flat_NMR = Flatten()(conv1_NMR)
hidden11_NMR = Dense(27, activation='relu')(flat_NMR)
hidden12_NMR = Dense(9, activation='relu')(hidden11_NMR)
