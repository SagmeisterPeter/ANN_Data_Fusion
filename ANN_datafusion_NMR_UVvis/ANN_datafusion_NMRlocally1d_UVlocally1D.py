...
conv1_NMR = LocallyConnected1D(filters=16, kernel_size=9, strides=9, activation ='elu')(visible_NMR) #convolutional layer for NMR (tune filters, kernel size, strides and the activation function)
flat_NMR = Flatten()(conv1_NMR)                                                           #flatten of the NMR convolutional layer 
hidden11_NMR = Dense(27, activation='elu')(flat_NMR)                                      #dense layer 1 NMR connected to the flatten layer of NMR (tune neurons and activation function)
hidden12_NMR = Dense(9, activation='elu')(hidden11_NMR)                                   #dense layer 2 NMR connceted to the dense layer 1 NMR (tune neurons and activation function)
...
hidden13 = Dense(16, activation='relu')(hidden11)                                   #dense layer 3 comb connected to dense layer 2 comb (tune neurons and activation function)
