...
visible = Input(shape=(600,))
hidden11 = Dense(600,activation='relu')(visible)
hidden12 = Dense(243, activation='relu')(hidden11)
hidden13 = Dense(81, activation='relu')(hidden12)
